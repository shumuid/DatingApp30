...
namespace DatingApp.API.Signers
{
    ...
    {
        public string FormatCredentialStringForPolicy(DateTime dateTimeStamp, string region, string service)
        {
            //to do: need to get keys from data base
            return $"{Settings.AWSAccessKey}/{dateTimeStamp}/{region}/{service}/{TERMINATOR}";                
        }
